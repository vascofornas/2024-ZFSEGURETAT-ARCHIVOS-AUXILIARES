...
WHERE tarea.fecha_hora_vencimiento > DATE(NOW() - INTERVAL 7 DAY)  AND tarea.fecha_hora_vencimiento <= DATE(NOW()) AND tarea.estado = 1  AND tarea.usuario_asignado = '".$idUsuario."'
