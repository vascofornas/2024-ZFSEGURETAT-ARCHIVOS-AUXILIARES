...
WHERE tarea.fecha_hora_vencimiento > DATE(NOW() - INTERVAL 7 DAY)  AND tarea.fecha_hora_vencimiento <= DATE(NOW()) AND tarea.estado = 4  AND tarea.grupo = '".$idDepartamento."' AND tarea.categoria = '".$idCategoria."'
